const { sum, sub, prod, digital_root, sum42, sayHelloTo, anomalyCode, ReLU } = require('./sketch');
...
test('Relu function exists', () => {
  expect(ReLU).toBeDefined();
})

test('Relu -1 should be 0', () => {
  expect(ReLU(-1)).toBe(0);
})

test('Relu 1 should be 1', () => {
